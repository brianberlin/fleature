defmodule FleatureWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: FleatureWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/fleature_web/templates",
        namespace: FleatureWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {FleatureWeb.LayoutView, "live.html"}
