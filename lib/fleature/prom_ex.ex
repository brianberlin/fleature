defmodule Fleature.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule FleatureWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Fleature.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: FleatureWeb.Router, endpoint: FleatureWeb.Endpoint},
      Plugins.Ecto,
      Plugins.Oban,
      ...
      Fleature.PromEx.FeatureFlagsPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:fleature, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
